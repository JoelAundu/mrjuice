...
const MessagesWrapper: React.FC<MessagesWrapperProps> = ({
    ...
    const initialConversations: Conversation[] = [
      {
        ...
        isUnread: true,
        messages: [],
        userImage: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&auto=format&fit=crop&w=42&h=42&q=80", // Unsplash image
      },
      {
        ...
        userImage: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3&auto=format&fit=crop&w=46&h=46&q=80", // Unsplash image
      },
    ];
    ...
    const handleSendMessage = (content: string) => {
      ...
      const updatedConversations = conversations.map((conv) => {
        if (conv.userName === selectedConversation) {
          ...
          return {
            ...conv,
            lastMessage: `You: ${content.slice(0, 20)}${content.length > 20 ? "..." : ""}`,
            timestamp: new Date().toLocaleTimeString([], {
              hour: "2-digit",
              minute: "2-digit",
            }),
    ...
    const selectedConv = conversations.find(
      (conv) => conv.userName === selectedConversation
    ) || null;
